...
\`
```{r}
write.csv(cdc_wonder_mortality_data, "cdc_wonder_mortality_data_cleaned.csv", row.names = FALSE)
write.csv(cdc_wonder_population_data, "cdc_wonder_population_data_cleaned.csv", row.names = FALSE)
write.csv(medicaid_data, "medicaid_data_cleaned.csv", row.names = FALSE)
write.csv(medicare_data, "medicare_data_cleaned.csv", row.names = FALSE)
