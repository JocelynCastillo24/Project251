...
# We imported 2 csv files from Milestone 3 i.e., 1. medicare_modified that contains state level medicare enrolment, utilisation, total medicare spending and a spending per capita vairable. 2. mortality_rate that contains state level data on total deaths and total population for age groups 65 plus with a mortality rate per 1000 variable.
...
# Visualisation 4; Scatter Plot comparing Medicare spending and mortality rates
